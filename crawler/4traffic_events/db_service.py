...
def process_payload(payload: dict):
    ...
    if event == "":
        raise ValueError("Provide an event name!")
...
def check_datastream_existence(
    ...
    sql = f"""
        SELECT id
        FROM event_monitoring.datastreams
...
def create_datastream(
    ...
    sql = f"""
        INSERT INTO event_monitoring.datastreams (
            sensor_id,
            type,
            unit,
            event)
...
def insert_measurement(
    ...
    sql = f"""
        INSERT INTO event_monitoring.measurements (
            datastream_id,
            timestamp,
            value,
            event)
